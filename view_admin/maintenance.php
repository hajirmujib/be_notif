<?php 
$resultBaru = $conn->query("SELECT * FROM maintenance WHERE status='Baru' ORDER BY id DESC");
$resultProses = $conn->query("SELECT * FROM maintenance WHERE status='Proses' ORDER BY id DESC");
$resultSelesai = $conn->query("SELECT * FROM maintenance WHERE status='Selesai' ORDER BY id DESC");
      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-12">
              ...
              <a type="button" href="index.php?module=add_maintenance" class="btn btn-block btn-primary">Tambah Data  <i class="nav-icon fas fa-plus"></i></a> 
              </div>
